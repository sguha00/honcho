...
app_name = str("therapy-copilot-hackathon")
...
async def on_message(message):
    ...
    async with message.channel.typing():
        ...
        # copy the response to a new variable chunk
        chunk = response
        # loop through the response and send each message in chunks of 2000 characters or less
        while chunk:
